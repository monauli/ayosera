...
export type MappingSourceDocument = { _id?: string; storeId: number; kind: "excel" | "pdf"; period?: string; url: string; fileName: string; mimeType: string; size: number; sheets?: unknown; parsedReports?: unknown; parsedWithVersion?: string; uploadedAt: Date; uploadedBy: string };
