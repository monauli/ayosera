...
export type MappingSourceDocument = { _id?: string; storeId: number; kind: "excel" | "pdf"; period?: string; url: string; fileName: string; mimeType: string; size: number; sheets?: unknown; uploadedAt: Date; uploadedBy: string };
