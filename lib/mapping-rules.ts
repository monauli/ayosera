...
export const MAPPING_ALIAS_RULES: readonly MappingAliasRule[] = [
  ...
  { report: "cashflow", excelLabels: ["Total Aktivitas Investasi"], pdfLabel: "SubTotal Aktivitas Investasi" },
  { report: "cashflow", excelLabels: ["Total Aktivitas Pendanaan"], pdfLabel: "SubTotal Aktivitas Investasi" },
  { report: "cashflow", excelLabels: ["Pendapatan/pembelian aset tetap"], pdfLabel: "jam Pendapatan/pembelian aset tetap" },
  { report: "cashflow", excelLabels: ["Kenaikan/penuruan kas", "Kenaikan / Penurunan Kas"], pdfLabel: "Total Kenaikan/Penurunan Kas" },
