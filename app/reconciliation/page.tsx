                ...
                <section className="recon-finalization">
                  ...
                  {finalization?.status !== "locked" && (
                    <>
                      ...
                      {analysis?.matchStatus === "COCOK" && <p className="recon-readonly"><strong>Penyesuaian berdasarkan Berita Acara:</strong> {formatRupiah(analysis.nominal ?? 0)}<br /><strong>Residual:</strong> {formatRupiah(Math.abs(Math.abs(analysis.systemDifference) - Math.abs(analysis.nominal ?? 0)))} — Pembulatan</p>}
